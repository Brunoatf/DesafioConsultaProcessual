...
class LawsuitDatabase:
    ...
    - I implemented the database as a simple .json file for the sake of simplicity, as recommended by the challenge rules. 
    ...
    @staticmethod
    def search_lawsuits(cnj: str = None, court: str = None, start_date_interval: date = None, end_date_interval: date = None, plaintiff: str = None, defendant: str = None) -> typing.List[dict]:
